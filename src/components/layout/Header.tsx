...
export default function Header({ onSearch }: HeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-40 bg-black/50 backdrop-blur-xl border-b border-white/10 px-3 md:px-6 py-3 md:py-4 flex items-center justify-between gap-3">
